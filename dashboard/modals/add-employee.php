<!-- Add Modal -->
<div class="modal fade" id="add" tabindex="-1" data-bs-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" style="width: 600px">
    <form method="post" class="modal-content needs-validation" novalidate>
      ...
      <div class="modal-footer">
        <button type="submit" name="add" class="btn btn-success bg-gradient"><i class="bi bi-floppy"></i> Save Changes</button>
      </div>
    </form>
  </div>
</div>
